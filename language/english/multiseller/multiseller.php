...
$_['ms_error_sellerinfo_paypal'] = 'No IBAN-code / bankaccountnr';
$_['ms_error_sellerinfo_legal'] = 'You need to confirm you will respect all laws protecting the rights of authors.';
...
$_['ms_error_product_infected'] = 'This e-book possibly contains a virus. Therefore your e-book can\'t be sold via this website.';
$_['ms_error_product_invalid'] = 'This is not a valid e-book.';
$_['ms_error_product_drm'] = 'This e-book contains a DRM security. Therefore your e-book can\'t be sold via this website.';
$_['ms_error_product_no_watermark'] = 'This e-book doesn\'t contain a valid watermark. Therefore your e-book can\'t be sold via this website.';
$_['ms_error_product_uploaded_before'] = 'You uploaded this e-book before. You can\'t sell an e-book twice!';
$_['ms_error_product_legal_owner'] = 'You need to confirm that you are the legal owner of the e-book.';
$_['ms_account_product_bundle_note'] = 'Sell your e-books in a bundle. Select an e-book with your mouse while you push the control button.';
$_['ms_warning_product_not_current_owner'] = 'Warning: We recognize this book and it\'s possible you didn\'t receive this from a legal source. If that is the case, you might be punishable by law by selling this book.';
$_['ms_validation_error'] = 'This book could not be validated.';
$_['ms_banned_error'] = 'This book has been identified as not-legal. Therefore your e-book can\'t be sold via this website.';
$_['ms_watermark_error'] = 'Sorry! Tom couldn\'t provide your e-book with a watermark. Therefore your e-book can\'t be sold via this website.';
...
$_['ms_account_sellerinfo_paypal'] = 'IBAN-code';
$_['ms_account_sellerinfo_paypal_note'] = 'Specify your IBAN / Bankaccount code';
...
$_['ms_account_sellerinfo_legal'] = 'I agree that I will not perform any ilegal sales on this platform.';
$_['ms_account_sellerinfo_legal_note'] = 'I will handle according all laws protecting the rights of authors';
...
$_['ms_account_dashboard_nav_user_dashboard'] = 'To user dashboard';
...
$_['ms_account_withdraw_no_paypal'] = 'Please <a href="index.php?route=seller/account-profile">specify your IBAN code / bankaccountnr</a> first!';
