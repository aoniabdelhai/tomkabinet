...
$_['text_payment_description'] = 'U betaald %s elke %d %s(en) gedurende %d betaling(en).';
...
$_['error_profile_required'] = 'Selecteer een betalingsprofiel!';

$_['text_trial']             = '%s elke %s %s gedurende %s betalingen, dan ';
