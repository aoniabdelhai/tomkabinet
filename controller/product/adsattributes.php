...
class ControllerProductAdsattributes extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->request['search']))
        {
            ...
            $this->request->request['filter_title'] = $filter_name;
        ...
        if (isset($this->request->request['filter_description']))
        {
        ...
        if ($quicksearch == false)
        {
            ...
            if (isset($this->request->request['filter_title']))
            {
        ...
        if (isset($this->request->request['filter_isbn']))
        {
        ...
        if (isset($this->request->request['filter_tag']))
        {
        ...
        if (isset($this->request->request['filter_manufacturer_id']))
        {
        ...
        if (isset($this->request->request['filter_language']))
        {
        ...
        if (isset($this->request->request['filter_category_id']))
        {
        ...
        if (isset($this->request->request['filter_sub_category']))
        {
        ...
        if (isset($this->request->request['filter_pricemin']))
        {
        ...
        if (isset($this->request->request['filter_pricemax']))
        {
        ...
        if (isset($this->request->request['filter_groups']))
        {
        ...
        if (isset($this->request->request['search']))
        {
            $url .= '&filter_name=' . $this->request->request['search'];
        }

        if (isset($this->request->request['filter_name']))
        {
            $url .= '&filter_name=' . $this->request->request['filter_name'];
        }

        if (isset($this->request->request['filter_title']))
        {
            $url .= '&filter_title=' . $this->request->request['filter_title'];
        }

        if (isset($this->request->request['filter_author']))
        {
            $url .= '&filter_author=' . $this->request->request['filter_author'];
        }

        if (isset($this->request->request['filter_isbn']))
        {
            $url .= '&filter_isbn=' . $this->request->request['filter_isbn'];
        }

        if (isset($this->request->post['filter_tag']))
        {
            $url .= '&filter_tag=' . $this->request->request['filter_tag'];
        }

        if (isset($this->request->request['filter_description']))
        {
            $url .= '&filter_description=' . $this->request->request['filter_description'];
        }

        if (isset($this->request->request['filter_language']))
        {
            $url .= '&filter_language=' . $this->request->request['filter_language'];
        }

        if (isset($this->request->request['filter_category_id']))
        {
            $url .= '&filter_category_id=' . $this->request->request['filter_category_id'];
        }

        if (isset($this->request->request['filter_sub_category']))
        {
            $url .= '&filter_sub_category=' . $this->request->request['filter_sub_category'];
        }

        if (isset($this->request->request['filter_pricemin']))
        {
            $url .= '&filter_pricemin=' . $this->request->request['filter_pricemin'];
        }

        if (isset($this->request->request['filter_pricemax']))
        {
            $url .= '&filter_pricemax=' . $this->request->request['filter_pricemax'];
        }

        if (isset($this->request->request['filter_groups']))
        {
            $url .= '&filter_groups=' . $this->request->request['filter_groups'];
        }

        if (isset($this->request->request['filter_attribute']))
        {
            $url .= '&filter_attribute=' . $this->request->request['filter_attribute'];
        }
