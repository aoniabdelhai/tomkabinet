	...
	<form id="ms-new-product" method="post" enctype="multipart/form-data">
		...
		<div class="content">
     	<div id="general-tabs" class="htabs">
			...
			<?php
			$data_tab_fields = array('model', 'sku', 'upc', 'ean', 'jan',
			'isbn', 'mpn', 'manufacturer', 'taxClass', 'subtract',
			'stockStatus', 'dateAvailable', 'bookType', 'author', 'genre',
			'publicationDate', 'page_count');
			$intersection_fields = array_intersect($data_tab_fields, $this->config->get('msconf_product_included_fields'));
			print_r($intersection_fields);
			?>
     	...
     	<div id="tab-general">
			...
			foreach ($languages as $k => $language) {
                ...
                <?php } ?>
                    ...
                    <?php if (in_array('bookType', $this->config->get('msconf_product_included_fields'))) { ?>
					<tr>
                    <td><span class="required"><?php if ($k == $first) { echo
                    '*'; } ?></span>Boek Formaat</td>
                    <td>
                        <input type="radio" name="book_type"  value="epub">Epub<br>
                        <input type="radio" name="book_type" value="mobi" checked >Mobi<br>
                        <input type="radio" name="book_type" value="pdf" checked >Pdf<br>
                    </td>
					</tr>
					<?php } ?>
                    <?php if (in_array('publicationDate', $this->config->get('msconf_product_included_fields'))) { ?>
                    <tr>
                    ...
                    <?php } ?>
                    <?php if (in_array('author', $this->config->get('msconf_product_included_fields'))) { ?>
                    <tr>
                        <td>Auteur</td>
                        <td>
                            <input type="text" name="book_author"
                            value="" />
                            <p class="ms-note"><?php echo "Auteur: Voor en
                            achternaam"; ?></p>
                        </td>
                    </tr>
                    <?php } ?>

                    <?php if (in_array('pages', $this->config->get('msconf_product_included_fields'))) { ?>
                    <tr>
                        <td>Pagina's</td>
                        <td>
                            <input type="number" name="book_pages"
                            value="" />
                            <p class="ms-note"><?php echo "Aantal pagina's" ?></p>
                        </td>
                    </tr>
                    <?php } ?>
					<tr>
