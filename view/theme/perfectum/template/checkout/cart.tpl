...
<div id="topcart">
   <img src="image/data/background/book_bg.png">
</div>

<div id="contentcategory_wrapper">
<?php echo $column_left; ?><?php echo $column_right; ?>
<div id="contentcart"><?php echo $content_top; ?>
<?php if ($attention) { ?>
...
<?php } ?>
        ...
        <tbody>
          ...
          <tr>
            <td class="image"><?php if ($product['thumb']) { ?>
              ...
              <?php } ?></td>
            <td class="name"><a href="<?php echo $product['href']; ?>" id="name"><?php echo $product['name']; ?></a>
            ...
            <td class="total">        
                <span class="price"><?php echo $product['total']; ?><a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/default/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></span>
            </td>
          </tr>
          <?php } ?>
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $checkout; ?>" class="button">&rsaquo; <?php echo $button_checkout; ?></a></div>
    <div class="left"><a href="<?php echo $continue; ?>" class="button">&rsaquo; <?php echo $button_shopping; ?></a></div>
  </div>
	 ...
	 <div class="content couponbox">
	   <p>Wat wilt u nu doen?</p>
	   <table class="radio">
	 ...
	 <div class="cart-module">
	   <div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
	     <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
	       ...
	       <span class="footnote">Er wordt ten minste 0,45 cent in rekening gebracht als het totaalbedrag na verrekening van de kortingsbon minder dan dit bedrag is.</span>
