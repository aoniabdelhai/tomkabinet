...
<div id="contentcheckoutoverlay"><?php echo $content_top; ?>
  ...
  <div class="checkout">
    ...
    <?php } } ?>
    <?php if ($shipping_required && false) { ?>
...
$('#button-account').live('click', function() {
	$.ajax({
		...
		success: function(html) {
			...
			$('#register-form .checkout-content').html(html);
				
			$('#checkout .checkout-content').slideUp('slow');
				
			$('#registerform .checkout-content').slideDown('slow');
...
$('#button-register').live('click', function() {
	$.ajax({
		...
		type: 'post',
		//data: $('#checkout #register :input'),
		data: $('#checkout #register input[type=\'text\'], #checkout #register input[type=\'password\'], #checkout #register input[type=\'checkbox\']:checked, #checkout #register input[type=\'radio\']:checked, #checkout #register input[type=\'hidden\'], #checkout #register select'),
		dataType: 'json',
		beforeSend: function() {
