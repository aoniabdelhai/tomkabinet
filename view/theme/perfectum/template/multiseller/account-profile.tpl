...
<div id="contentaccountoverlay" class="ms-account-profile">
	...
	<form id="ms-sellerinfo" class="ms-form">
		...
		<div class="content">
			...
			<table class="ms-product">
				<tr>
					<?php if (false && !empty($seller['ms.nickname'])) { ?>
				...
				<tr>
					...
					<td>
						<input type="text" name="seller[paypal]" value="<?php echo $seller['ms.paypal']; ?>" />&nbsp;<span class="faq fa-question tooltip" titlett="<?php echo $ms_account_sellerinfo_paypal_note; ?>"></span>
					</td>
				</tr>
