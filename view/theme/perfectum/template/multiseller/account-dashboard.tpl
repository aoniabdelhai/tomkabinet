   ...
   <div id="contentaccountoverlay" class="ms-account-dashboard clearfix">
	...
	<div class="overview">
		...
		<p>
			...
			<span>
			<?php echo $this->currency->getSymbolLeft(); ?> 1,50 per ebook (nu tijdelijk
	...
	<div class="nav">
		...
		<a href="<?php echo $this->url->link('account/account', '', 'SSL'); ?>">
			<span><?php echo $ms_account_dashboard_nav_user_dashboard; ?></span>
		</a>
